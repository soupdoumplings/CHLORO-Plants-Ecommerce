...
export const AuthProvider = ({ children }) => {
  ...
  return (
    <AuthContext.Provider value={{ user, session, isAdmin, loading, signUp, signIn, signOut, signInWithProvider, signInWithPhone, verifyPhoneOtp, sendPasswordResetOtp, verifyEmailOtp, updatePassword }}>
      {children}
