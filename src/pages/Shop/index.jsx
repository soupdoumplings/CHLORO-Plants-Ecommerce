...
const ShopPage = () => {
  return (
    ...
    >
      ...
      <main className="w-full max-w-[1440px] mx-auto px-6 md:px-12 pt-24 md:pt-32 pb-24 md:pb-48">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 md:mb-24 gap-8">
           <div className="text-left space-y-6 max-w-2xl">
              ...
              <motion.h1 
                ...
                className="font-headline text-5xl md:text-7xl lg:text-9xl tracking-tighter text-[#31332C] leading-none"
              >
           ...
           <motion.div 
             ...
             className="flex flex-wrap gap-6 md:gap-12 font-sans text-[11px] tracking-[0.1em] uppercase font-bold text-[#31332C]/40 border-b border-[#31332C]/5 pb-2 w-full md:w-auto"
           >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-12 gap-y-16 md:gap-y-24">
          {ALL_PLANTS.map((p, i) => (
