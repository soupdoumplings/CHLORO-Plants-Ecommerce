...
const INITIAL_MESSAGES = [
  {
    id: 1,
    sender: 'bot',
    text: 'Namaste. I can help with plant care, gifts, orders, and a little botanical drama.',
  },
];
          ...
          >
            <div className="flex items-center justify-between border-b border-[#D8D0C0] bg-[#11110E] px-4 py-3 text-[#FBF9F4]">
              <div className="flex min-w-0 items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-1 font-body text-[12px] text-[#FBF9F4]/58">
            ...
            <div className="no-scrollbar flex-1 overflow-y-auto bg-[#F8F5EE] px-4 py-4">
              ...
              {!currentCategory && !hasConversation && (
                <div className="mb-5 border-t border-[#D8D0C0]">
                  {Object.keys(CATEGORIES).map((category) => (
                    <button
                      key={category}
                      type="button"
                      onClick={() => setCurrentCategory(category)}
                      className="group flex w-full items-center justify-between border-b border-[#D8D0C0] py-3.5 text-left transition-colors duration-200 hover:bg-[#FFFEFA]"
                    >
                ...
                <div className="mb-5 grid grid-cols-1 gap-2">
                  {CATEGORIES[currentCategory].actions.map((action) => (
                    <button
                      ...
                      disabled={isTyping}
                      className="flex w-full items-center justify-between border border-[#D8D0C0] bg-[#FFFEFA] px-4 py-3 text-left font-body text-[13px] leading-snug text-[#31332C] transition-colors duration-200 hover:border-[#11110E] hover:bg-white disabled:opacity-55"
                    >
                      <span>{action}</span>
              ...
              <div className="space-y-3 border-t border-[#D8D0C0] pt-5">
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                          {message.suggestions.slice(0, 3).map((suggestion) => (
                            <button
                              ...
                              className="border border-[#D8D0C0] bg-[#F8F5EE] px-3 py-1.5 font-label text-[8px] font-bold uppercase tracking-[0.12em] text-[#11110E] transition-colors hover:border-[#11110E] hover:bg-white"
                            >
                              {suggestion}
                            </button>
                          ))}
                ...
                {isTyping && (
                  <div className="flex justify-start">
                    <div className="flex items-center gap-2 border border-[#D8D0C0] bg-white px-4 py-3">
            ...
            <form onSubmit={handleSubmit} className="flex items-center gap-2 border-t border-[#D8D0C0] bg-[#FFFEFA] px-3 py-2.5">
              ...
              <button
                ...
                className="flex h-10 w-10 shrink-0 items-center justify-center bg-[#11110E] text-[#FBF9F4] transition-colors hover:bg-[#2F2A22] disabled:bg-[#B1B3A9]"
                title="Send message"
              >
