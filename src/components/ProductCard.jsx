             ...
             <div className="text-right">
               {product.is_on_sale ? (
                 <div className="flex flex-col items-end">
                   <span className="font-serif text-[#785a1a] text-lg font-medium">रू {product.discount_price}</span>
                   <span className="font-serif text-[#31332c] text-sm line-through opacity-50">रू {product.price}</span>
                 </div>
               ) : (
